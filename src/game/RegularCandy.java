...
public class RegularCandy extends Candy
{
	...
	public RegularCandy(Candy[][] board, int row, int column){
		...
		this.setIcon(new ImageIcon("./src/pictures/pictures/"+COLORS.get(color)+".png"));
...
//		this.setText(row+", "+col);
	...
	public boolean visit(RegularCandy candy){
		...
		int up=this.amountUp(),down=this.amountDown(),left=this.amountLeft(),right=this.amountRight();
